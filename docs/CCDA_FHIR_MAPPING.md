...
`fhirToCda` builds the same 5 sections and header back into C-CDA XML — the tables above
apply in reverse, field for field. Two differences from a strict inverse:
