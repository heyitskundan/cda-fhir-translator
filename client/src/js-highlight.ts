 ...
 * C-CDA): comments, strings/template literals, numbers, declaration keywords, control-flow
 * keywords, and function-call names each get their own color. Not a full parser — a
 * single-pass tokenizer, same approach as the JSON/C-CDA highlighters, good enough for
